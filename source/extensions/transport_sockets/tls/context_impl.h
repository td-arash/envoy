...
private:
  ...
  const std::unordered_map<std::string,bssl::UniquePtr<SSL_CTX>>::iterator& getContextMapIteratorForServerName(const std::string server_name);
  ...
  std::shared_timed_mutex context_map_mutex_;
